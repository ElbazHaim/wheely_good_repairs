...
INSERT INTO Employees VALUES
    ('Maya', 'Cohen', '987654321', '1995-09-20', '2020-03-10',  1, 2, 
    'maya@gmail.com', 'Jerusalem', '456 King David St', 55000.00, 'Student', '9876543210'),
    ('Noam', 'Katz', '555555555', '1992-11-10', '2019-07-15',  1, 2, 
    'noam@gmail.com', 'Haifa', '789 Carmel Ave', 58000.00, 'BSc. Accounting', '5555555555'),
    ('May', 'Avraham', '333333333', '1989-07-02', '2023-06-01', 1, 2, 
    'may@gmail.com', 'Haifa', '567 Herzl St', 57000.00, 'Student in Accounting', '3333333333');

-- Customer Service
INSERT INTO Employees VALUES
    ('Inbar', 'Sapir', '890112345', '1993-02-28', '2021-12-01', 2, 3, 
            'inbar@example.com', 'Jerusalem', '505 Birch', 62000.00, 'Diploma in Auto Mechanics', '8901234567890'),
    ('Yoni', 'Lazarus', '901232456', '1989-11-15', '2018-10-20', 2, 3, 
            'yoni@example.com', 'Jerusalem', '606 Oak', 58000.00, 'BSc. English Literature', '9012345678901'),
    ('Lior', 'Golan', '012343567', '1991-07-30', '2022-04-05', 2, 3, 
            'lior@example.com', 'Jerusalem', '707 Pine', 54000.00, Null, '0123456789012'),
    ('Noga', 'Cohen', '987654432', '1994-04-22', '2019-08-18', 2, 3, 
...
INSERT INTO CustomerServices VALUES
    (7, 4.56, 1),
    (8, 3.50, 1),
    (9, 4.94, 0),
    (10, 3.07, 1),
...
INSERT INTO Parts VALUES
    ('Engine Oil', 30, 25.99, '1 Quart', 'ACME Motors'),
    ('Brake Pads', 25, 39.95, 'Standard', 'BrakeTech'),
    ('Air Filter', 5, 12.50, 'Standard', 'FilterMaster'),
    ('Spark Plugs', 13, 8.99, 'Set of 4', 'SparkTech'),
    ('Radiator Hose', 3, 18.75, '18 inches', 'CoolantCo'),
    ('Fuel Pump', 32, 65.00, 'Standard', 'Fueltronics'),
    ('Transmission Fluid', 9, 19.50, '1 Quart', 'GearLube'),
    ('Alternator', 11, 120.75, 'Standard', 'PowerGen'),
    ('Thermostat', 20, 14.25, 'Standard', 'TempControl'),
    ('Serpentine Belt', 28, 23.50, 'Accessory', 'BeltMaster');
...
INSERT INTO Vehicles VALUES
    ('12345678', 'GOLF20', 1, 50000, 2, 'ABC123456', 'Red'),
    ('23456789', 'CIVIC19', 2, 75000, 1, 'DEF456789', 'Blue'),
    ('34567890', 'NINJA21', 3, 30000, 0, 'GHI789012', 'Green'),
    ('45678901', 'JETTA18', 4, 60000, 3, 'JKL012345', 'Silver'),
    ('56789012', 'MODEL322', 5, 45000, 1, 'MNO345678', 'Black'),
    ('67890123', 'F15020', 1, 80000, 2, 'PQR678901', 'White'),
    ('78901234', 'MODEL322', 4, 25000, 0, 'STU901234', 'Gray');
--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=--=
-- Inserts for relation tables
INSERT INTO Repairs VALUES
    (12, '12345678', 1, '2023-01-15 09:00:00', '2023-01-15 11:00:00', 275.00),
    (13, '34567890', 3, '2023-02-20 13:30:00', '2023-02-20 16:30:00', 198.55),
    (14, '56789012', 2, '2023-03-10 10:00:00', '2023-03-10 14:00:00', 413.32),
    (15, '12345678', 5, '2023-04-05 12:45:00', '2023-04-05 17:00:00', 264.28),
    (16, '23456789', 4, '2023-05-18 14:00:00', '2023-05-18 20:00:00', 605.00),
    (17, '45678901', 6, '2023-06-07 16:30:00', '2023-06-07 19:30:00', 319.55),
    (12, '45678901', 7, '2023-07-10 15:45:00', '2023-07-10 20:00:00', 385.00),
    (13, '67890123', 10, '2023-03-28 09:30:00', '2023-03-28 12:30:00', 308.28),
    (14, '56789012', 8, '2023-02-10 14:00:00', '2023-02-10 18:00:00', 297.00),
